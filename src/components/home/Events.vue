        ...
        <v-row align="center" justify="center">
            <v-col cols="12" md="10" lg="10" sm="12" class="text-center mb-0" >
                <p class="google-font mb-1" style="font-weight: 350;font-size:180%">
                    <b>
                        <span style="color:#E7E736;">INFORMACION</span> 
                        &
                        <span style="color:#E7E736;">TECNOLOGIA </span> 
                    </b> 
                </p>
                
                <!-- <p class="google-font mb-0" style="font-size:180%">Our Events & Meetups</p> -->
                <p class="google-font mt-0" style="font-size:95%">La historia de los robots tienen sus orígenes desde el mundo antiguo. El concepto "moderno" empezó a ser desarrollado con el inicio de la Revolución Industrial,
                     lo que permitió el uso de mecánica compleja, y la introducción subsiguiente de electricidad.
                     Esto hizo posible que máquinas compactas y pequeñas funcionasen.</p>
                <router-link
                    to="/events"
                    text
                    color="#4C4A78"
                    class="ma-0 google-font mb-0"
                    style="border-radius:5px;text-transform: capitalize;text-decoration:none;color:#E7E736"
                >#SERES MECANICOS VIVIENTES</router-link>
            </v-col>
